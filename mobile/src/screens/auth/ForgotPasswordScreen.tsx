  ...
  return (
    ...
    >
      <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backBtn}>
        <Ionicons name="arrow-back" size={24} color={T.surface2} />
      </TouchableOpacity>

      <View style={styles.iconWrap}>
        <Ionicons name="mail" size={40} color={T.primary2} />
      </View>
...
const styles = StyleSheet.create({
  ...
  iconWrap:     { width: 80, height: 80, borderRadius: 24, backgroundColor: T.surface2, alignItems: 'center', justifyContent: 'center', marginBottom: 24 },
  ...
  successTitle: { fontSize: 18, fontWeight: '700', color: T.green, marginTop: 12, marginBottom: 8 },
  successText:  { fontSize: 14, color: T.green, textAlign: 'center' },
})
